...
def build_clear_label():
   ...
   #  dataset = pd.read_csv(PROCESSED_DATA_DIR / "enamex_sentences.csv")
    ...
    dataset = pd.read_csv(r"D:\HK6\CS321_NNHNL\goal_data_5.csv")
    ...
    # Save result
    with open(r"D:\HK6\CS321_NNHNL\clear_label.csv", "w", encoding="utf-8", newline="") as file:
        writer = csv.writer(file, quoting=csv.QUOTE_ALL)
        writer.writerow(["id", "sentences"])
        writer.writerows(result)

    print("Clear label saved to clear_label_id.csv")
